...
import CV from "../../assets/terese_CV.pdf"
            ...
            <div className={styles.about__container}>
                <div className={styles.about__data}>
                    ...
                    <p className={styles.about__description}>
                        I’m a passionate software developer with over a year of hands-on experience,
                        driven by the challenge of building efficient, scalable solutions. Specializing in both backend and frontend development,
                        I work with technologies like Java, Python, JavaScript (Spring Boot, Django, Flask, React, React Native, Node.js),
                        and I’m proficient in styling with CSS and Tailwind. I also leverage AWS and Docker for deployment and containerization.
                        Collaboration and test-driven development are central to my approach,
                        and I use GitHub for version control and GitHub Actions for CI/CD to ensure smooth project delivery.
                        Always eager to take on new challenges, I’m excited to contribute to innovative projects and create something amazing.
                        Let’s connect!
                    </p>
